...
<div id="style">
    <div class="outerbox">
        ...
        <div class="mainHeading"><h2 id="styleHeading"><?php echo "Add Style Code"; ?></h2></div>
        <form name="frmStyle" id="frmStyle" method="post" action="<?php echo url_for('content/style'); ?>" >

            <?php echo $form['_csrf_token']; ?>
            <?php echo $form->renderHiddenFields(); ?>

            <div class="newColumn">
                <?php echo $form['styleCode']->renderLabel('Style Code'. ' <span class="required">*</span>'); ?>
                <?php echo $form['styleCode']->render(array("class" => "formInput", "maxlength" => 100)); ?>
